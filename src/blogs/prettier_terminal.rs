...
pub fn content() -> Html {
    ...
    html! {
        <>
        <h1 >{"How to make an aesthetic terminal"}</h1>
        <p>{"From"}</p>
        <img  src="https://raw.githubusercontent.com/SpanishPear/portfolio/main/src/assets/blogs/assets/images/basic-terminal.png"/>
        <p>{"to"}</p>
        <img  src="https://raw.githubusercontent.com/SpanishPear/portfolio/main/src/assets/blogs/assets/images/pretty-terminal.png"/>
        ...
        <p><img  src="https://raw.githubusercontent.com/SpanishPear/portfolio/main/src/assets/blogs/assets/images/1511-colours.png"/></p>
        ...
        <p><img  src="https://raw.githubusercontent.com/romkatv/powerlevel10k-media/master/prompt-styles-high-contrast.png"/></p>
        ...
        <pre>
            <code >{"sh -c "}<span >{"\""}<span >{"$(wget -O- https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)"}</span>{"\""}</span>
            </code>
        </pre>
        ...
        <pre>
            <code >{"git clone --depth="}<span >{"1"}</span>{" https:"}<span >{"//gi"}</span>{"tee.com"}<span >{"/romkatv/"}</span>{"powerlevel10k.git "}<span >{"${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}"}</span><span >{"/themes/"}</span>{"powerlevel10k"}
            </code>
        </pre>
        <p>{"and then finally, we set the theme (should be on line 11) in our "}<code>{"~/.zshrc</code>:"}</code></p>
        <pre>
            <code ><span >{"ZSH_THEME"}</span>{"="}<span >{"\"powerlevel10k/powerlevel10k\""}</span>
            </code>
        </pre>
        <p>{"We also want to add the following line to our zshrc file (preferably the end!)"}</p>
        <pre>
            <code ><span >{"export"}</span>{"TERM=xterm"}<span >{"-256"}</span><span >{"color"}</span>
            </code>
        </pre>
        ...
        <pre>
            <code ><span >{"source"}</span>{" ~/.zshrc"}
            </code>
        </pre>
        <p>{"in order to see it take effect. "}</p>
        <p>{"If nothing happens, run: "}</p>
        <pre><code><span >{"zsh"}</span>
        ...
        <pre>
            <code><span >{"export"}</span>{" SHELL="}<span >{"\"/usr/local/bin/zsh\";"}</span>
            <span >{"exec"}</span>{" "}<span >{"\""}<span >{"$SHELL"}</span>{"\""}</span>{" "}<span >{"-l"}</span>{";"}
            </code>
        </pre>
        ...
        <pre><code >{"plugins=(git zsh-syntax-highlighting)"}
        </code></pre>
        <p>{"and then running"}</p>
        <pre><code ><span >{"source"}</span>{" ~/.zshrc"}
        </code></pre>
        ...
        <pre>
            <code >
            <span >{"plugins"}</span>{"=(git zsh-syntax-highlighting zsh-autosuggestions)"}
            </code>
        </pre>
        <p>{"and then running"}</p>
        <pre>
        ...
        <pre>
            <code >
                <span >{"plugins"}</span>{"=(git zsh-syntax-highlighting zsh-autosuggestions zsh-z)"}
            </code>
        </pre>
        <p>{"and update"}</p>
        <pre>
        ...
        <img  src="https://raw.githubusercontent.com/SpanishPear/portfolio/main/src/assets/blogs/assets/images/exa.png" alt="exa picture"/></p>
        <p>{"simply run"}</p>
        <pre>
            <code >
                {"cargo install exa"}
        ...
        <pre>
            <code ><span >{"alias"}</span>{" "}<span >{"ll"}</span>{"="}<span >{"\"exa -l\""}</span>
            </code>
        </pre>
        <p>{"in my `~/.zshrc`"}</p>
        ...
        <pre>
            <code >{"curl "}<span >{"https://gist.insou.dev/gitstatus | sh"}</span>
            </code>
        </pre>
        <p>{"followed by"}</p>
        <pre>
