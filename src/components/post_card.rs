...
pub fn post_card(props: &PostCardProps) -> Html {
    ...
    html! {
    <div onclick={goto_post} class="transform transition duration-500 hover:scale-110 hover:cursor-pointer m-1 max-w-sm bg-white rounded-lg border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
            ...
            <Link<Route> to={Route::BlogPost { id: props.post.slug.to_string() }} classes="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                {"Read more"}
